...
class PatientListViewForm(forms.ModelForm):
    ...
    referredFrom = forms.ModelMultipleChoiceField(
        required=False,
    ...
    cause = forms.ModelMultipleChoiceField(
        required=False,
    ...
    diagnose = forms.ModelMultipleChoiceField(
        required=False,
    ...
    investigation = forms.ModelMultipleChoiceField(
        required=False,
        queryset=Investigation.objects.all(),
        label="Investigations",
        initial=[
            Investigation.objects.all().values_list("investigationName", flat=True)
        ],
    )
