...
class AppointmentCreateViewForm(forms.ModelForm):
    ...
    appointmentDate = forms.DateField(
        label="Appointment date", widget=forms.DateInput(format="%Y-%m-%d")
    )
    appointmentType = forms.ChoiceField(
        choices=AppointmentTypes, required=False, label="Appointmen type"
    )
    appointmentStatus = forms.ChoiceField(
        label="Appointment Status", choices=AppointmentStatuss
    )
    operation = forms.ModelMultipleChoiceField(
        required=False,
    ...
    followup = forms.ModelMultipleChoiceField(
        required=False,
    ...
    new_visit = forms.ModelMultipleChoiceField(
        required=False,
        queryset=NewVisit.objects.all(),
        label="new visit reason",
